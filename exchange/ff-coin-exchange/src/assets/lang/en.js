module.exports = {
    ...
    header: {
        ...
        ctc: "C2C Exchange",
        labdetail: "ffcoin Lab  ●  Sharing innovation results",
    ...
    sectionPage: {
        ...
        baseexchangetips: "How to buy and sell on ffcoin",
    ...
    ctc: {
        ...
        desc:"Crypto assets are managed by ffcoin, and the acceptor provides exchange services for exchange.",
        buyin: "Buy",
        sell: "Sell",
        buyprice: "Buy Price",
        sellprice: "Sell Price",
    ...
    activity: {
        ...
        attentiontxt4: "* The right of final interpretation of this activity belongs to the official ownership of ffcoin.",
        ...
        submit: "Submit",
        tipsmobile: "Please use PC web（www.fufeng.com）",
    ...
    invite: {
        ...
        ruleprofile1:"[Promotion Partner] is the highest proportion of online Commission return and the longest time of commission return (maximum lifetime commission). Promoters who make corresponding efforts can become real platform ‘partners’ and enjoy the dividend of growing together with ffcoin trading platform. Detailed rules are as follows:",
        ruleprofile2:"The highest rebate ratio",
        ruleprofile3:"The longest rebate period (maximum lifetime rebate)",
        ruleprofile4:"The promotion activities, so that the promoters who have made corresponding efforts can become platform partners in the true sense, and enjoy the bonus of growing together with the ffcoin trading platform! The specific rules are as follows:",
        ...
        ruletext8: "8、TOP10 or TOP100 will be awarded additional incentives by ffcoin from time to time.",
        ...
        ruletext11: "11、The right of final interpretation of this activity belongs to ffcoin.",
        ...
        thanks: "Thank you for supporting ffcoin！",
    ...
    uc: {
        ...
        identity: {
            ...
            become: "Become ffcoin Certified Business and enjoy more transaction privileges",
    ...
    cms: {
        ...
        download: "Download",
        downloadslogan: "ffcoin APP - Trade everywhere."
    },
    crowdfunding: {
    ...
    description: {
        ...
        aboutdesc1: "We established the ffcoin crowdfunding website in New York, USA in April 2009. We are committed to supporting and motivating innovative and creative activities. Through crowdfunding, we allow creative people to get the funds they need and help them realize their dreams. In 2010, he won the Best Invention Award from Time Magazine. In 2011, Time Magazine awarded the title of Best Website. In 2014, he was certified by B Corp. In 2015, he became a Public-Benefit Corporation (PBC) from a traditional profitable company. The Chinese founder Perry Chen and his team founded the ffcoin charity exchange with the support of many international charity organizations. It makes full use of the features of blockchain technology such as traceability, non-tampering, and data encryption security to establish a global Set a more open, transparent, simple and efficient charity currency and charity financial infrastructure to realize the full-process storage of information and behaviors in the charity process, full-cycle traceability and audit, so as to achieve point-to-point assistance to people affected by disasters in the epidemic , Let people all over the world live a better life.",
        aboutdesc2: "With the global outbreak of COVID-19 in 2020, Chinese founder Perry Chen and his team founded the ffcoin charity exchange with the support of many international charity organizations, which make full use of the traceability, immutability, and data encryption security of blockchain technology. Characteristic, a more open, transparent, simple, and efficient charity currency and charity financial infrastructure have been established on a global scale to realize the full-process storage of information and behaviors in the process of charity and the full-cycle traceability and audit. Achieve point-to-point assistance to people affected by the epidemic, so that people all over the world can live a better life.",
        ...
        apply: "Board Apply",
        coop: "Cooperation",
        community: "ffcoin Community",
        wechat: "Wechat",
        addwechat: "Add 'ffcoin01' as Wechat friends and then enter Wechat community",
        weibo: "Weibo",
        twitter: "Twitter",
        biyong: "Biyong",
        telegram: "Telegram",
    ...
    index: {
        ...
        BHBregister: "ffcoin account registration",
        ...
        fenpeijizhi: 'A description of the ffcoin income distribution mechanism',
    ...
    plate: {
        ...
        content1: "As described in the white paper, ffcoin will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.",
