  ...
  watch: {
    activeNav: function() {
      switch (this.activeNav) {
        case "nav-exchange":
          window.document.title = (this.lang == "简体中文" ? "交易中心" : "Exchange") + " - ffcoin | 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-service":
          window.document.title = (this.lang == "简体中文" ? "公告" : "Announcement") + " - ffcoin | 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-about":
          window.document.title = (this.lang == "简体中文" ? "关于" : "About") + " - ffcoin | 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-lab":
          window.document.title = (this.lang == "简体中文" ? "公益创新室" : "Lab") + " - ffcoin | 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-mining":
          window.document.title = (this.lang == "简体中文" ? "矿机" : "Mining") + " - ffcoin | 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-invite":
          window.document.title = (this.lang == "简体中文" ? "全球传递爱" : "Promotion") + " - ffcoin | 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        default:
          window.document.title = "ffcoin | ffcoin官网 - 全球比特币交易平台 | 全球数字货币交易平台";
          break;
      }
    },
    $route(to, from) {
